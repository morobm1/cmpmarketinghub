...
const studentWelcomeBlocks: EmailBlock[] = [
  ...
  { id: bid(), type: 'image-text', data: { style: { backgroundColor: '', textColor: '#333333', paddingTop: 16, paddingBottom: 16, paddingLeft: 24, paddingRight: 24, textAlign: 'left' }, visible: true, imageUrl: '', imageAlt: 'Community amenities', imagePosition: 'left', imageWidth: 45, heading: 'Community Amenities', body: 'Enjoy resort-style amenities including a fitness center, study lounges, community spaces, and more. Everything designed with your student lifestyle in mind.' } },
  { id: bid(), type: 'image-text', data: { style: { backgroundColor: '#f8f4ff', textColor: '#333333', paddingTop: 16, paddingBottom: 16, paddingLeft: 24, paddingRight: 24, textAlign: 'left' }, visible: true, imageUrl: '', imageAlt: 'Room features', imagePosition: 'right', imageWidth: 45, heading: 'Your Suite Awaits', body: 'Fully furnished suites with modern amenities, high-speed WiFi, and comfortable common areas. Your home away from home starts here.' } },
...
const luxuryMarketingBlocks: EmailBlock[] = [
  ...
  { id: bid(), type: 'image-text', data: { style: { backgroundColor: '', textColor: '#333333', paddingTop: 16, paddingBottom: 16, paddingLeft: 24, paddingRight: 24, textAlign: 'left' }, visible: true, imageUrl: '', imageAlt: 'Lifestyle quality', imagePosition: 'right', imageWidth: 45, heading: 'Lifestyle Quality', body: 'One of the factors that makes our residents stay longer is by knowing their needs and considering their lifestyle.', buttonLabel: 'View More', buttonUrl: '#' } },
  { id: bid(), type: 'image-text', data: { style: { backgroundColor: '', textColor: '#333333', paddingTop: 16, paddingBottom: 16, paddingLeft: 24, paddingRight: 24, textAlign: 'left' }, visible: true, imageUrl: '', imageAlt: 'Green spaces', imagePosition: 'left', imageWidth: 45, heading: 'Green and Open Spaces', body: 'We have designed green and open spaces for our residents to have a little greenery in the city.', buttonLabel: 'View More', buttonUrl: '#' } },
...
const newsletterBlocks: EmailBlock[] = [
  ...
  { id: bid(), type: 'image-text', data: { style: { backgroundColor: '', textColor: '#333333', paddingTop: 16, paddingBottom: 16, paddingLeft: 24, paddingRight: 24, textAlign: 'left' }, visible: true, imageUrl: '', imageAlt: 'Upcoming event', imagePosition: 'left', imageWidth: 40, heading: 'Upcoming Events', body: 'March 15 - Community BBQ\nMarch 22 - Fitness Class\nMarch 28 - Movie Night' } },
  { id: bid(), type: 'divider', data: { style: { backgroundColor: '', paddingTop: 4, paddingBottom: 4, paddingLeft: 32, paddingRight: 32, textAlign: 'center' }, visible: true, color: '#e2e8f0', thickness: 1, widthPercent: 100, lineStyle: 'solid' } },
